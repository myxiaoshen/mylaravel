...
@section('leirong')
  ...
  <div class="panel-head" id="add"><strong><span class="i con-pencil-square-o"></span>添加内容</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="{{url('list')}}">
      {{csrf_field()}}
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="art_title" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          ...
          <script src="http://127.0.0.1/XLblog/resources/org/uploadify/jquery.uploadify.js" type="text/javascript"></script>
          ...
          <script type="text/javascript">
              ...
              $(function() {
                  $('#file_upload').uploadify({
                      ...
                      'uploader' : 'http://127.0.0.1/XLblog/resources/org/uploadify/uploadify.php'
                  });
              });
          </script>
        ...
        <div class="form-group">
          ...
          <div class="field">
            <select class="input w50">
              ...
              <option value="cate_id">请选择分类</option>
              @foreach($lr as $s)
              <option value="">{{$s->cate_name}}</option>
              @endforeach
            </select>
            <div class="tips"></div>
          </div>
      ...
      <div class="form-group">
        ...
        <div class="field" >
          <textarea class="input" name="art_miaoshu" style=" height:90px;"></textarea>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          ...
          <script id="editor" name="art_text" type="text/plain" style="width:860px;height:500px;"  data-validate="required:内容不能为空"></script>
          {{--实例化编辑器--}}
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="art_user" value="" data-validate="required:请输入作者" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="art_view" value="" data-validate="member:只能为数字"  />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
